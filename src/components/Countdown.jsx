  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div
        ...
        style={{
          boxShadow:
            "0 2px 16px 0 rgba(180,155,100,0.10), inset 0 1px 0 rgba(255,255,255,0.6)",
        }}
      >
      ...
      <p className="font-elle text-gold text-[10px] sm:text-xs tracking-[0.25em] uppercase">
        {label}
      </p>
    </div>
  );
...
function openGoogleCalendar() {
  const params = new URLSearchParams({
    ...
    details:
      "Resepsi Pernikahan Chelsea Rosari Mahakintha Samoling & Ranu Barta Fahrizal. Pukul 11.00 – 14.00 WIB.",
    location:
      "Pendopo Kinanthi, Perumahan Wonolopo Asri, Wonolopo, Kec. Mijen, Kota Semarang, Jawa Tengah 50215",
  });
  window.open(
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <div
          className="countdown-title text-center mb-14 space-y-3"
          style={{ opacity: 0 }}
        >
        ...
        <div
          className="ayat-block text-center mt-16 px-4 md:px-12"
          style={{ opacity: 0 }}
        >
          ...
          <blockquote className="font-cormorant text-sage-dark text-xl md:text-2xl font-light italic leading-relaxed mb-4">
            "Sejauh apa pun melangkah, hati tahu ke mana ia harus pulang. Di
            antara doa-doa sederhana, kami menemukan jawaban yang sama. Kami
            menanti kehadiran Anda untuk menjadi saksi janji suci kami."
          </blockquote>
        ...
        <div
          className="countdown-info text-center mt-14 space-y-3"
          style={{ opacity: 0 }}
        >
