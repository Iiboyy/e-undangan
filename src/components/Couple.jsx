...
const FloralCorner = ({ className, style }) => (
  ...
  >
    <g opacity="0.35">
      <path
        d="M10 110 Q40 70 80 20"
        stroke="#C9A646"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M10 110 Q50 80 90 50"
        stroke="#C9A646"
        strokeWidth="0.8"
        fill="none"
      />
      <path
        d="M30 85 Q20 65 40 60 Q45 75 30 85Z"
        fill="#5A7A52"
        opacity="0.6"
      />
      <path
        d="M50 65 Q35 50 55 42 Q62 57 50 65Z"
        fill="#7D9B76"
        opacity="0.5"
      />
      <path
        d="M65 45 Q55 28 72 25 Q76 40 65 45Z"
        fill="#5A7A52"
        opacity="0.6"
      />
...
const FloralSprig = ({ className, style }) => (
  ...
  >
    <g opacity="0.3">
      <path
        d="M40 155 Q38 100 40 10"
        stroke="#C9A646"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M40 120 Q20 110 18 95 Q32 98 40 120Z"
        fill="#7D9B76"
        opacity="0.7"
      />
      <path
        d="M40 120 Q60 110 62 95 Q48 98 40 120Z"
        fill="#5A7A52"
        opacity="0.7"
      />
      <path
        d="M40 85 Q22 75 20 60 Q34 63 40 85Z"
        fill="#7D9B76"
        opacity="0.6"
      />
      <path
        d="M40 85 Q58 75 60 60 Q46 63 40 85Z"
        fill="#5A7A52"
        opacity="0.6"
      />
      <path
        d="M40 52 Q25 42 24 30 Q36 33 40 52Z"
        fill="#7D9B76"
        opacity="0.5"
      />
      <path
        d="M40 52 Q55 42 56 30 Q44 33 40 52Z"
        fill="#5A7A52"
        opacity="0.5"
      />
...
const FloralScatter = ({ className, style }) => (
  ...
  >
    <g opacity="0.25">
      ...
      <path
        d="M30 50 Q35 40 45 45 Q40 55 30 50Z"
        fill="#7D9B76"
        opacity="0.6"
      />
      <path
        d="M60 20 Q68 15 72 25 Q64 28 60 20Z"
        fill="#5A7A52"
        opacity="0.5"
      />
      <path
        d="M10 75 Q15 65 25 70 Q20 78 10 75Z"
        fill="#7D9B76"
        opacity="0.5"
      />
    </g>
...
export default function Couple() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".floral-scatter-1, .floral-scatter-2",
        { opacity: 0, y: 16 },
        {
          opacity: 1,
          y: 0,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <div
          className="couple-title text-center mb-16 space-y-3"
          style={{ opacity: 0 }}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          <div
            className="bride-card text-center space-y-6"
            style={{ opacity: 0 }}
          >
          ...
          <div
            className="groom-card text-center space-y-6"
            style={{ opacity: 0 }}
          >
            <div className="relative mx-auto w-48 h-48 md:w-56 md:h-56">
              <div className="absolute inset-0 border border-gold/40 rounded-full rotate-6" />
            ...
            <div className="space-y-3 pt-4">
              ...
              <p className="font-elle text-cream/60 text-sm leading-relaxed">
                Putra dari
                <br />
                <span className="text-cream/80">Bapak Subardo</span>
                <br />
