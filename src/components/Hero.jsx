    ...
    >
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(245,240,230,0.5) 0%, rgba(245,240,230,0.3) 50%, rgba(245,240,230,0.6) 100%)",
          }}
        />
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="blob-tl absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full opacity-[0.18]"
          style={{
            background:
              "radial-gradient(circle, #7D9B76 0%, #A8C5A0 40%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
          className="blob-tr absolute -top-20 -right-24 w-[380px] h-[380px] rounded-full opacity-[0.14]"
          style={{
            background:
              "radial-gradient(circle, #C9A646 0%, #E2C97E 50%, transparent 70%)",
            filter: "blur(70px)",
          }}
        />
        <div
          className="blob-br absolute -bottom-28 -right-20 w-[480px] h-[480px] rounded-full opacity-[0.20]"
          style={{
            background:
              "radial-gradient(circle, #5A7A52 0%, #7D9B76 45%, transparent 70%)",
            filter: "blur(65px)",
          }}
        />
        <div
          className="blob-bl absolute -bottom-16 -left-28 w-[360px] h-[360px] rounded-full opacity-[0.12]"
          style={{
            background:
              "radial-gradient(circle, #B8963E 0%, #C9A646 50%, transparent 70%)",
            filter: "blur(75px)",
          }}
        />
        <div
          className="blob-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full opacity-[0.08]"
          style={{
            background: "radial-gradient(ellipse, #A8C5A0 0%, transparent 65%)",
            filter: "blur(80px)",
          }}
        />
      </div>
        ...
        <div className="hero-names opacity-0">
          <h1
            ...
            style={{
              color: "#3D5C36",
              textShadow:
                "0 0 30px rgba(61,92,54,0.8), 0 0 60px rgba(61,92,54,0.4)",
            }}
          >
            Chelsea
          </h1>
          <p
            className="font-cormorant text-3xl md:text-4xl italic my-2"
            style={{ color: "#C9A646" }}
          >
            &
          </p>
      ...
      <div className="relative z-10 mt-12 flex flex-col items-center gap-2 opacity-50">
        <p className="font-elle text-sage text-xs tracking-widest uppercase">
          Scroll
        </p>
