...
const stories = [
  {
    ...
    icon: (
      ...
      >
        <path
          d="M6 32V12a2 2 0 012-2h10v22H6z"
          stroke="#C9A646"
          strokeWidth="1.2"
          fill="none"
        />
        <path
          d="M18 10h10a2 2 0 012 2v20H18V10z"
          stroke="#C9A646"
          strokeWidth="1.2"
          fill="none"
        />
        <path
          d="M10 15h4M10 19h4M10 23h4"
          stroke="#C9A646"
          strokeWidth="1"
          strokeLinecap="round"
        />
        <path
          d="M22 15h4M22 19h4M22 23h4"
          stroke="#C9A646"
          strokeWidth="1"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M20 34C20 34 8 26 8 17a8 8 0 0112-6.93A8 8 0 0132 17c0 9-12 17-12 17z"
          stroke="#C9A646"
          strokeWidth="1.2"
          fill="none"
        />
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="story-item opacity-0 text-center mt-16 space-y-3">
          ...
          <p className="font-cormorant text-sage-dark/60 text-lg italic">
            "Bukan tentang seberapa lama mengenal, melainkan tentang memilih
            untuk tetap bersama dalam setiap keadaan."
          </p>
