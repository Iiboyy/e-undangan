      ...
      >
        {isPlaying && !isMuted && (
          <>
            ...
            />
            <span
              className="absolute inset-[-4px] rounded-full border border-gold/10 animate-ping"
        ...
        <span
          className={`font-cormorant text-lg select-none transition-colors duration-300 ${isMuted ? "text-cream/30" : "text-gold"}`}
        >
